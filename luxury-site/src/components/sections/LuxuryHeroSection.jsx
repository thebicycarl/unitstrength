...
const LuxuryHeroSection = ({ scrollToSection }) => {
  ...
  const onReplayClick = useCallback((e) => {
    e.stopPropagation();
    const video = videoRef.current;
    if (!video) return;
    video.muted = false;
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900">
        ...
        <div className="text-center">
          ...
          >
            <h1 className="text-5xl md:text-7xl font-light mb-4 text-white tracking-tight">
              <span className="block mb-2">The Compact</span>
              <span className="block font-normal">Enclosed Home Gym</span>
            </h1>

            <p className="text-lg md:text-xl text-gray-300 mb-6 max-w-2xl mx-auto font-light">
              A complete strength + conditioning setup that fits into a 1.2m x 0.6m footprint
            </p>

            <div className="flex flex-col md:flex-row items-center justify-center gap-4 md:gap-8 mb-10 text-white">
              <span className="text-lg md:text-xl font-medium">Train hard.</span>
              <span className="hidden md:block text-gray-400">•</span>
              <span className="text-lg md:text-xl font-medium">Stay organised.</span>
              <span className="hidden md:block text-gray-400">•</span>
              <span className="text-lg md:text-xl font-medium">Save space.</span>
            </div>

            <div className="max-w-3xl mx-auto mb-10">
              <p className="text-base md:text-lg text-gray-300 mb-4 font-light leading-relaxed">
                Most home gyms are either huge or messy.
              </p>
              <p className="text-lg md:text-xl text-white font-normal leading-relaxed">
                This is the first self-contained, enclosed training station designed to give you a premium workout experience without eating a whole room.
              </p>
            </div>
            ...
            <Button
              ...
              size="lg"
              className="pointer-events-auto btn-primary text-white text-lg px-12 py-6 rounded-none border-2 border-white/20 hover:border-white/40 transition-all duration-300 bg-black/40 backdrop-blur-sm hover:bg-black/60"
            >
      ...
      {/* Scroll — after 30s threshold; above tap layer */}
      {showScrollHint && (
